...
//            .map { preferences ->
//                Tokens(
//                    accessToken = preferences[ACCESS_TOKEN_KEY]?.let { decrypt(it) },
//                    refreshToken = preferences[REFRESH_TOKEN_KEY]?.let { decrypt(it) }
//                )
//            }
//            .first()
//
...
//            it[ACCESS_TOKEN_KEY] = encrypt(accessToken)
//            it[REFRESH_TOKEN_KEY] = encrypt(refreshToken)
//        }
//    }
//
